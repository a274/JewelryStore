...
class TypeServiceTest {
    ...
    @Test
    void getAllTypes() {
        Mockito.when(typeRepo.findAll()).thenReturn(List.of(type1, type2, type3));
        assertEquals(List.of(type1, type2, type3), typeRepo.findAll());
    }

    @Test
    void saveType() {
        typeService.saveType(type1);
        Mockito.verify(typeRepo).save(captor.capture());
    ...
    void deleteById() {
        ...
        Mockito.verify(typeRepo).deleteById(3);
    }
}